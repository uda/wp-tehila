...
if ( ! function_exists( 'tehila_setup' ) ) :
/**
...
function tehila_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'tehila' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'tehila_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // tehila_setup
add_action( 'after_setup_theme', 'tehila_setup' );
 ...
 */
function tehila_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'tehila' ),
		'id'            => 'sidebar-1',
		'description'   => '',
 ...
 */
function tehila_scripts() {
	wp_enqueue_style( 'tehila-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'tehila_scripts' );
